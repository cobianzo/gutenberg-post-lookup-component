...
/***/ "./src/post-lookup/PostLookup.styles.ts":
/*!**********************************************!*\
  !*** ./src/post-lookup/PostLookup.styles.ts ***!
  \**********************************************/
...
var StyledPostLookup = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\n  position: relative;\n\n  .post-lookup {\n    position: relative;\n\n    input.components-text-control__input {\n      padding-right: 40px; // leave space for the x button\n    }\n\n    .x-button {\n      position: absolute;\n      top: 60px;\n      right: 10px;\n    }\n  }\n\n  ul {\n    background: #fffffff4;\n    padding: 0 0.5rem;\n    border: 1px solid #ccc;\n    box-shadow: 1px 7px 9px -9px #000000;\n    position: absolute;\n    width: 100%;\n    top: 44px;\n\n    li {\n      padding: 0;\n      border-bottom: 1px solid #cccccc;\n\n      button {\n        width: 100%;\n      }\n    }\n  }\n\n  button.button--unstyled {\n    display: flex;\n    gap: 1rem;\n    padding: 0.5rem;\n    align-items: center;\n    cursor: pointer;\n    background: transparent;\n    border: 0;\n    color: var(--wp-components-color-accent, var(--wp-admin-theme-color, #3858e9));\n  }\n  button.button--unstyled:hover {\n    background-color: rgba(var(--wp-admin-theme-color--rgb), .04);\n  }\n"], ["\n\n  position: relative;\n\n  .post-lookup {\n    position: relative;\n\n    input.components-text-control__input {\n      padding-right: 40px; // leave space for the x button\n    }\n\n    .x-button {\n      position: absolute;\n      top: 60px;\n      right: 10px;\n    }\n  }\n\n  ul {\n    background: #fffffff4;\n    padding: 0 0.5rem;\n    border: 1px solid #ccc;\n    box-shadow: 1px 7px 9px -9px #000000;\n    position: absolute;\n    width: 100%;\n    top: 44px;\n\n    li {\n      padding: 0;\n      border-bottom: 1px solid #cccccc;\n\n      button {\n        width: 100%;\n      }\n    }\n  }\n\n  button.button--unstyled {\n    display: flex;\n    gap: 1rem;\n    padding: 0.5rem;\n    align-items: center;\n    cursor: pointer;\n    background: transparent;\n    border: 0;\n    color: var(--wp-components-color-accent, var(--wp-admin-theme-color, #3858e9));\n  }\n  button.button--unstyled:hover {\n    background-color: rgba(var(--wp-admin-theme-color--rgb), .04);\n  }\n"])));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (StyledPostLookup);
...
/* harmony import */ var _PostLookup_styles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./PostLookup.styles */ "./src/post-lookup/PostLookup.styles.ts");
/* harmony import */ var _useDebounce__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./useDebounce */ "./src/post-lookup/useDebounce.ts");
/* harmony import */ var _usePostSearch__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./usePostSearch */ "./src/post-lookup/usePostSearch.ts");
/* harmony import */ var _usePost__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./usePost */ "./src/post-lookup/usePost.ts");
/* harmony import */ var _XButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./XButton */ "./src/post-lookup/XButton.tsx");
...
var PostLookup = function (props) {
  ...
  // STATES ============= ============= =============
  var _a = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null),
    searchTerm = _a[0],
    setSearchTerm = _a[1];
  var debouncedSearchTerm = (0,_useDebounce__WEBPACK_IMPORTED_MODULE_5__["default"])(searchTerm, 300);
  var _b = (0,_usePostSearch__WEBPACK_IMPORTED_MODULE_6__["default"])(debouncedSearchTerm),
    postResults = _b.posts,
    loading = _b.loading,
    error = _b.error;
  var selectedPostObject = (0,_usePost__WEBPACK_IMPORTED_MODULE_7__["default"])(selectedPostId).post;
  // ref of the control so we can assign focus
  var textControlRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  // HANDLERS ============= ============= =============
  var handleInputChange = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (value) {
    setSearchTerm(value);
  }, []);
  ...
  // JSX ============= ============= =============
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_PostLookup_styles__WEBPACK_IMPORTED_MODULE_4__["default"], {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      className: "post-lookup",
      children: [!selectedPostId && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        className: "post-lookup__preview",
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
          children: "No post selected"
        })
      }), selectedPostId && (selectedPostObject === null || selectedPostObject === void 0 ? void 0 : selectedPostObject.id) && searchTerm === null ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "post-lookup__preview",
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Search for a post', 'coco'),
          value: searchTerm || '',
          onChange: handleInputChange,
          placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Search…', 'coco'),
          ref: textControlRef
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_XButton__WEBPACK_IMPORTED_MODULE_8__["default"], {
          onClick: function () {
            return setSearchTerm(null);
          }
        }), loading && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, {}), error && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          className: "notice notice-error",
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Error:', 'coco') + error
          })
        }), postResults.length > 0 && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("ul", {
        ...
        }), selectedPostId ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
          children: [" ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Selected post ID:', 'coco') + selectedPostId, " "]
        }) : null]
      })]
    })
  });
...
function useDebounce(value, delay) {
  var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(value),
    debouncedValue = _a[0],
...
function usePost(postId) {
  var _a = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    isLoading = _a[0],
    setIsLoading = _a[1];
  var post = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    if (!postId) {
      return null;
    }
...
function usePostSearch(searchTerm) {
  var _a = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    posts = _a[0],
    setPosts = _a[1];
  var _b = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    loading = _b[0],
    setLoading = _b[1];
  var _c = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    error = _c[0],
    setError = _c[1];
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _post_lookup_PostLookup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../post-lookup/PostLookup */ "./src/post-lookup/PostLookup.tsx");
/* harmony import */ var _post_lookup_usePost__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../post-lookup/usePost */ "./src/post-lookup/usePost.ts");
...
function Edit(props) {
  var _a, _b, _c;
  var post = (0,_post_lookup_usePost__WEBPACK_IMPORTED_MODULE_5__["default"])(props.attributes.postID).post;
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", __assign({}, (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)(), {
      style: {
        border: '10px solid orange',
        background: 'lightgray',
        padding: '1rem'
      },
      children: post ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h2", {
          children: (_b = (_a = post === null || post === void 0 ? void 0 : post.title) === null || _a === void 0 ? void 0 : _a.rendered) !== null && _b !== void 0 ? _b : 'no post'
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
          dangerouslySetInnerHTML: {
            __html: (_c = post === null || post === void 0 ? void 0 : post.content) === null || _c === void 0 ? void 0 : _c.rendered.replace(/<[^>]+>/g, '')
          }
        })]
      }) : (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
        children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('No post selected', 'coco')
      })
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Panel, {
        children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_post_lookup_PostLookup__WEBPACK_IMPORTED_MODULE_4__["default"], {
            selectedPostId: props.attributes.postID,
            updateSelectedPostId: function (newPostId) {
...
var typedBlockJson = _block_json__WEBPACK_IMPORTED_MODULE_2__;
var name = typedBlockJson.name,
  settings = __rest(typedBlockJson, ["name"]);


// We register the block
// @ts-expect-error I can't type the registerBlockType properly.
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_2__.name, __assign(__assign({
  name: name
}, settings), {
...
function Save() {
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", __assign({}, _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save()));
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgutenberg_post_selector_component"] = self["webpackChunkgutenberg_post_selector_component"] || [];
